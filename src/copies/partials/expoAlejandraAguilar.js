...
module.exports.es = {
    expoDescription: fs.readFileSync('./src/copies/partials/expoAlejandraAguilarDescriptionEs.txt').toString('utf-8'),
...
module.exports.en = {
    expoDescription: fs.readFileSync('./src/copies/partials/expoAlejandraAguilarDescriptionEn.txt').toString('utf-8'),
    username: 'User name',
    message: 'Message',
...
module.exports.fr = {
    expoDescription: fs.readFileSync('./src/copies/partials/expoAlejandraAguilarDescriptionFr.txt').toString('utf-8'),
    username: 'Nom',
    message: 'Message',
